                    ...
                    <div class="form-container">
                        <div class="card">
                            <div class="welcome-image pt-3">
                                <img src="files/images/welcome.PNG" style="width: 87%;height: 176px;" alt="">
                            </div>
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="email"
                                                    class="col-md-4 col-form-label text-md-end">{{ __('Profession') }} <span
                                                        style="color:red">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select id="country" type="text"
                                                    ...
                                                    autocomplete="country" placeholder="Select A Country">
                                                    <option value="" selected disabled>Select A Country</option>
                                                        ...
                                                        <option value="LA">Lao People's Democratic Republic (the)
                                                        </option>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="city"
                                                    class="col-md-4 col-form-label text-md-end">{{ __('City') }} <span
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="zipcode"
                                                    class="col-md-4 col-form-label text-md-end">{{ __('ZipCode') }} <span
                                                        style="color:red">*</span></label>
                                                <input id="zipcode" type="text"
                                                    class="form-control @error('zipcode') is-invalid @enderror"
                                                    name="zipcode" value="{{ old('zipcode') }}" required
                                                    autocomplete="zipcode" placeholder="Enter Your Zipcode">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="email"
                                                    class="col-form-label text-md-end">{{ __('Email Address') }} <span
                                                        style="color:red">*</span></label>
