                            ...
                            <div class="course_card" style="border:1px solid black;height:400px">
                                ...
                                <div class="course_card_content">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        @if($tool->price === "0")
                                        <p class="text-center badge badge-primary" style="font-size: 24px">Free Tool</p>
                                    @else
                                        <p class="text-center badge badge-primary" style="font-size: 24px">Price: {{$tool->price}}</p>
                                    @endif
                                    </div>
                                </div>
                            </div>
